...
<head>
    ...
    <title>GEMPI Registration</title>
...
<div class="registration-container">
    ...
    <div class="registration-form">
        ...
        <form method="POST" action="{{ route('register.submit') }}">
            ...
            <button type="submit" class="btn register-button w-100">Daftar</button>
            <p class="login-link">Sudah Punya Akun? <a href="logiin">Login Disini</a></p>
        </form>
